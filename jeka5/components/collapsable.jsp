...
%><div class="card">
  <a class="card-header" style="background-color: ${color.value}" role="button" data-toggle="collapse" href="#collapse-${compid}" aria-expanded="false" aria-controls="collapse-${compid}">
