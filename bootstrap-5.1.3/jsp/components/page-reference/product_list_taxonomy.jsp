					...
					<div class="row">
						<c:if test="${not empty image}">
							<div class="col-md-2 col-img">
								<figure>
									<a ${popup?'class="popup" ':''} title="${page.titleForAttribute}" href="${page.linkOn}"> <img class="img-responsive" src="${image.url}" class="frame" alt="${image.description}" />
									</a>
								</figure>
							</div>
						</c:if>
						<div class="col-md-${param.image?'10':'12'} col-caption">
							<div class="caption">
								...
								<h3>
									<a ${popup?'class="popup" ':''} title="${page.titleForAttribute}" href="${page.linkOn}">${page.title}</a>
								</h3>
