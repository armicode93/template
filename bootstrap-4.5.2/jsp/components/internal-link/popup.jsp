  ...
  <div class="modal-dialog modal-xl" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <c:set var="lang" value="${contentContext.language}" />
        ...
        <jsp:setProperty name="contentContext" property="currentPageCached" value="${null}" />
        <jsp:setProperty name="contentContext" property="allLanguage" value="${lang}" />
        </c:if>
	  </div>
    </div>
  </div>
...
document.addEventListener("DOMContentLoaded", function(event) {
	if (!getCookie("popup-${compid}")) {
		setCookie("popup-${compid}", true, 365);
		$('#modal-${compid}').modal();
	}
});
</script>
